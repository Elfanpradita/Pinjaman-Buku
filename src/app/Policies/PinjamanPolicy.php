...
class PinjamanPolicy
{
    ...
    {
        return $user->can('view_any_pinjaman');
    }
    ...
    {
        return $user->can('create_pinjaman');
    }
    ...
    {
        return $user->can('update_pinjaman');
    }
    ...
    {
        return $user->can('delete_pinjaman');
    }
    ...
    {
        return $user->can('delete_any_pinjaman');
    }
     ...
     */
    public function replicate(User $user, Pinjaman $pinjaman): bool
    {
